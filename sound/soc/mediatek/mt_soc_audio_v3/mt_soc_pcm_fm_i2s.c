...
static int mtk_pcm_fm_i2s_prepare(struct snd_pcm_substream *substream)
{
    ...
    if (mPrepareDone == false)
    {
        ...
        printk("%s Soc_Aud_InterConnectionOutput_O00 and Soc_Aud_InterConnectionOutput_O01\n", __func__);
        SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I10, Soc_Aud_InterConnectionOutput_O00); //add
        SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I11, Soc_Aud_InterConnectionOutput_O01); //add
