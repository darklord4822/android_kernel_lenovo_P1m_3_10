...
extern unsigned int UbVbat; 

//+Other_platform_add huangfusheng.wt ADD 20150604 add debug info
static kal_int32 batt_hw_ocv=0;//brian-add
static kal_int32 batt_sw_soc=0;//brian-add
static kal_int32 batt_hw_soc=0;//brian-add
static kal_int32 batt_rtc_soc=0;//brian-add
static kal_int32 batt_ub_vbat=0;
static kal_int32 batt_ub_soc=0;
//-Other_platform_add huangfusheng.wt ADD 20150604 add debug info
