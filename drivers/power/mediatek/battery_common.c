...
extern  kal_uint32 ui_soc_sync_100_enable ;
#endif
#ifdef WT_VBAT_LOW_PERCENT_TRACKING
extern kal_int32 fgauge_read_capacity_by_v(kal_int32 voltage); //Other 20150420 huangfusheng.wt add add low vbat percent tracking
#endif
/* ////////////////////////////////////////////////////////////////////////////// */
/* FOR ADB CMD */
/* ////////////////////////////////////////////////////////////////////////////// */
...
static kal_bool mt_vbat_soc_n_percent_tracking(void)
{
		...
		kal_bool resetBatteryMeter = KAL_FALSE;
		static kal_uint32 timer_counter = (VBATSOC_SYNC_TO_SOC_TRACKING_TIME/BAT_TASK_PERIOD);	
		
		kal_uint32 vbat_checking_point = V_LOW_BAT_CHECK ;
		kal_uint32 vbat_checking_point_SOC = fgauge_read_capacity_by_v(vbat_checking_point);
...
static void mt_battery_Sync_UI_Percentage_to_Real(void)
{
	...
	static kal_uint32 init_UI_SOC = 0; 
