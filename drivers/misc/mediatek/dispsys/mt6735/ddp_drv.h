...
#define DISP_IOCTL_GET_PQSTANDARD_PARAM_FROM_LCDDRV  _IOR  (DISP_IOCTL_MAGIC,92 , DISP_PQ_PARAM)
#define DISP_IOCTL_GET_PQVIVID_PARAM_FROM_LCDDRV  _IOR  (DISP_IOCTL_MAGIC, 93 , DISP_PQ_PARAM)
#endif
#endif
