...
extern void ncp1854_set_jeita_opt(kal_uint32 val);//+Other_platform_modify huangfusheng.wt 20150609 modify for hub detect fail;

//+ Other_lenovo_req huangfusheng.wt add 20150704 otg short circuit test
extern kal_uint32 ncp1854_get_vobstol2_status(void);
extern void  ncp1854_set_vobstol1_set(kal_uint32 val);
extern void  ncp1854_set_vobstol2_set(kal_uint32 val);
extern void  ncp1854_set_int_mask(kal_uint32 val);
extern  kal_uint32 ncp1854_get_vobstol2_sns_status(void);
extern kal_uint32 ncp1854_get_faultint(void);
extern void ncp1854_vbusok_mask_set(kal_uint32 val);
extern void ncp1854_tsd_mask_set(kal_uint32 val);
extern void  ncp1854_tm2_mask_set(kal_uint32 val);
extern void ncp1854_tm1_mask_set(kal_uint32 val);
extern void ncp1854_tmwarning_mask_set(kal_uint32 val);
