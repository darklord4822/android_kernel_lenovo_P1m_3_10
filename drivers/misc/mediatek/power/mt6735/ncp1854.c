...
//CON6
kal_uint32 ncp1854_get_vobstol2_status(void)
{
    kal_uint32 ret=0;
    kal_uint32 val=0;
    ...
    ret=ncp1854_read_interface((kal_uint8)(NCP1854_CON6),
	        					      (kal_uint8*)(&val),
							      (kal_uint8)(CON6_VOBSTOL2_MASK),
							      (kal_uint8)(CON6_VOBSTOL2_SHIFT)
							      );
    return val;
}
...
//CON7
kal_uint32 ncp1854_get_vobstol2_sns_status(void) 
{
		kal_uint32 ret=0;
		kal_uint8 val=0;
	
		ret=ncp1854_read_interface((kal_uint8)(NCP1854_CON7),
										  (&val),
									  (kal_uint8)(CON7_VOBSTOL2_SNS_MASK),
									  (kal_uint8)(CON7_VOBSTOL2_SNS_SHIFT)
									  );
		return val;
}
...
void ncp1854_vbusok_mask_set(kal_uint32 val)
{
    kal_uint32 ret=0;

    ret=ncp1854_config_interface((kal_uint8)(NCP1854_CON10),
                                                   (kal_uint8)(val),
                                                   (kal_uint8)(CON10_VBUSOK_MASK),
                                                   (kal_uint8)(CON10_VBUSOK_SHIFT)
                                                   );
}

void ncp1854_tsd_mask_set(kal_uint32 val)
{
    kal_uint32 ret=0;

    ret=ncp1854_config_interface((kal_uint8)(NCP1854_CON10),
                                                   (kal_uint8)(val),
                                                   (kal_uint8)(CON10_TSD_MASK),
                                                   (kal_uint8)(CON10_TSD_SHIFT)
                                                   );
}

void ncp1854_tm2_mask_set(kal_uint32 val)
{
    kal_uint32 ret=0;

    ret=ncp1854_config_interface((kal_uint8)(NCP1854_CON10),
                                                   (kal_uint8)(val),
                                                   (kal_uint8)(CON10_TM2_MASK),
                                                   (kal_uint8)(CON10_TM2_SHIFT)
                                                   );
}

void ncp1854_tm1_mask_set(kal_uint32 val)
{
    kal_uint32 ret=0;

    ret=ncp1854_config_interface((kal_uint8)(NCP1854_CON10),
                                                   (kal_uint8)(val),
                                                   (kal_uint8)(CON10_TM1_MASK),
                                                   (kal_uint8)(CON10_TM1_SHIFT)
                                                   );
}

void ncp1854_tmwarning_mask_set(kal_uint32 val)
{
    kal_uint32 ret=0;

    ret=ncp1854_config_interface((kal_uint8)(NCP1854_CON10),
                                                   (kal_uint8)(val),
                                                   (kal_uint8)(CON10_TWARN_MASK),
                                                   (kal_uint8)(CON10_TWARN_SHIFT)
                                                   );
}
//- Other_lenovo_req huangfusheng.wt add 20150704 otg short circuit test
...
void ncp1854_set_vobstol1_set(kal_uint32 val)
{
    kal_uint32 ret=0;

    ret=ncp1854_config_interface((kal_uint8)(NCP1854_CON13),
								(kal_uint8)(val),
								(kal_uint8)(CON13_VOBSTOL1_MASK),
								(kal_uint8)(CON13_VOBSTOL1_SHIFT)
								);
}

void ncp1854_set_vobstol2_set(kal_uint32 val)
{
    kal_uint32 ret=0;

    ret=ncp1854_config_interface((kal_uint8)(NCP1854_CON13),
								(kal_uint8)(val),
								(kal_uint8)(CON13_VOBSTOL2_MASK),
								(kal_uint8)(CON13_VOBSTOL2_SHIFT)
								);
}
...
#define NCP1854_BUSNUM 1 //Other 20150422 huangfusheng.wt modify ncp1854 rsense config
#endif
